...
Robotics and systems, Los Angeles. I like building the whole stack: mechanisms, control math, firmware, and the instruction set underneath.

**Now:** sim-to-real reinforcement learning for VEX AI (training in simulation with domain randomization, deploying on a Jetson Orin Nano with onboard vision), and 3D scene reconstruction tooling as an intern at UCLA SRILAB.
...
Founded Tech for Change at my school: hands-on engineering lessons (3D-printed gear-train kits, intro neural networks) that have reached about 80 students so far.
